#!/bin/bash
#SBATCH --job-name=blastn_plasmid_search
#SBATCH --output=logs/blastn_%j.out
#SBATCH --error=logs/blastn_%j.err
...
QUERY_FASTA="data/selected_genes.fasta"
DB_NAME="plasmid_db"
OUTPUT_TSV="output/blastn_results.tsv"
EVALUE="1e-10"
